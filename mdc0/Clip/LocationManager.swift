...
extension LocationManager
{
    ...
    enum Error: LocalizedError, RecoverableError
    {
        ...
        var failureReason: String? {
            switch self
            {
            case .requiresAlwaysAuthorization: return NSLocalizedString("mdc0 requires “Always” location permission.", comment: "")
            }
        }
        ...
        var recoverySuggestion: String? {
            switch self
            {
            case .requiresAlwaysAuthorization: return NSLocalizedString("Please grant mdc0 “Always” location permission in Settings so it can run in the background indefinitely.", comment: "")
            }
        }
